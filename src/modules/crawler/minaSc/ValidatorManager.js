...
export class ValidatorManager extends SmartContract {
  ...
  getValidatorIndex(p) {
    ...
    return Provable.if(
      isValidator1,
      Field(1),
      Provable.if(isValidator2, Field(2), Provable.if(isValidator3, Field(3), Field(0))),
    );
  }
...
__decorate([state(PublicKey), __metadata('design:type', Object)], ValidatorManager.prototype, 'validator1', void 0);
__decorate([state(PublicKey), __metadata('design:type', Object)], ValidatorManager.prototype, 'validator2', void 0);
__decorate([state(PublicKey), __metadata('design:type', Object)], ValidatorManager.prototype, 'validator3', void 0);
__decorate([state(PublicKey), __metadata('design:type', Object)], ValidatorManager.prototype, 'manager', void 0);
__decorate(
  [
    method,
