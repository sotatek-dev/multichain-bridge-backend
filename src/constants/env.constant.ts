export enum EEnvKey {
  ...
  MINA_MANAGER_CONTRACT_ADDRESS = 'MINA_MANAGER_CONTRACT_ADDRESS',
  MINA_VALIDATOR_MANAGER_CONTRACT_ADDRESS = 'MINA_VALIDATOR_MANAGER_CONTRACT_ADDRESS',
  ETH_SIGNER_PUBLIC_KEY = 'ETH_SIGNER_PUBLIC_KEY',
  NUMBER_OF_BLOCK_PER_JOB = 'NUMBER_OF_BLOCK_PER_JOB',
  ADMIN_MESSAGE_FOR_SIGN = 'ADMIN_MESSAGE_FOR_SIGN',
  MINA_SIGNER_PUBLIC_KEY = 'MINA_SIGNER_PUBLIC_KEY',
